    ...
    >
      ...
      >
        ...
        <div style={{ position: 'relative' }}>
          ...
          >
            Your reputation,{' '}
            <em style={{ color: 'rgba(255,255,255,.7)', fontStyle: 'italic' }}>verified</em>{' '}
        ...
        <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', gap: '.75rem' }}>
          {[
            { icon: '🔒', label: 'Work email verification' },
            { icon: '✓', label: 'Manual approval by you' },
            { icon: '🔗', label: 'Shareable public profile' },
          ].map((item) => (
            <div
              key={item.label}
              style={{
