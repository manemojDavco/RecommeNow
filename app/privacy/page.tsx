    ...
    <>
      ...
      <main style={{ maxWidth: 740, margin: '0 auto', padding: '8rem 2.5rem 6rem', fontFamily: 'var(--sans)' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', fontSize: '.9rem', lineHeight: 1.75, color: 'var(--ink)' }}>
          ...
          <section>
            <h2 style={{ fontFamily: 'var(--sans)', fontSize: '1.15rem', fontWeight: 700, marginBottom: '.6rem' }}>1. Who we are</h2>
          ...
          <section>
            <h2 style={{ fontFamily: 'var(--sans)', fontSize: '1.15rem', fontWeight: 700, marginBottom: '.6rem' }}>2. Data we collect</h2>
          ...
          <section>
            <h2 style={{ fontFamily: 'var(--sans)', fontSize: '1.15rem', fontWeight: 700, marginBottom: '.6rem' }}>3. How we use your data</h2>
          ...
          <section>
            <h2 style={{ fontFamily: 'var(--sans)', fontSize: '1.15rem', fontWeight: 700, marginBottom: '.6rem' }}>4. Public profiles</h2>
          ...
          <section>
            <h2 style={{ fontFamily: 'var(--sans)', fontSize: '1.15rem', fontWeight: 700, marginBottom: '.6rem' }}>5. Third-party services</h2>
          ...
          <section>
            <h2 style={{ fontFamily: 'var(--sans)', fontSize: '1.15rem', fontWeight: 700, marginBottom: '.6rem' }}>7. Your rights</h2>
          ...
          <section>
            <h2 style={{ fontFamily: 'var(--sans)', fontSize: '1.15rem', fontWeight: 700, marginBottom: '.6rem' }}>8. Cookies</h2>
          ...
          <section>
            <h2 style={{ fontFamily: 'var(--sans)', fontSize: '1.15rem', fontWeight: 700, marginBottom: '.6rem' }}>9. Security</h2>
          ...
          <section>
            <h2 style={{ fontFamily: 'var(--sans)', fontSize: '1.15rem', fontWeight: 700, marginBottom: '.6rem' }}>10. Changes to this policy</h2>
          ...
          <section>
            <h2 style={{ fontFamily: 'var(--sans)', fontSize: '1.15rem', fontWeight: 700, marginBottom: '.6rem' }}>11. Contact</h2>
